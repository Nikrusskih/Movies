...
public class MovieDetailActivity extends AppCompatActivity {
    ...
    private MovieDetailViewModel viewModal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModal = new ViewModelProvider(this).get(MovieDetailViewModel.class);
        initViews();
        ...
        viewModal.getFavoriteMovie(movie.getId()).observe(this, new Observer<Movie>() {
            @Override
            public void onChanged(Movie movieFromDb) {
                if (movieFromDb == null) {
                    ...
                    imageViewStar.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            viewModal.removeMovie(movie.getId());
                        }
                    });
                }
            }
